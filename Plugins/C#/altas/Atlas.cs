...
public class Altas : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (int i = 0; i < panels.Count; i++)
        {
            ...
            Vector3 end = new Vector3(Convert.ToSingle(pointInfo.PositionX), Convert.ToSingle(pointInfo.PositionY), Convert.ToSingle(pointInfo.PositionZ));
